                    ...
                    {block name="frontend_detail_buy_button_container"}
                        <div class="buybox--button-container block-group{if $NotifyHideBasket && $sArticle.notification && $sArticle.instock <= 0} is--hidden{/if}">
                            ...
                            {block name="frontend_detail_buy_button"}
                                ...
                                {else}
                                    <button class="buybox--button block btn is--primary is--icon-left is--center is--large" name="{s name="DetailBuyActionAdd"}{/s}"{if $buy_box_display} style="{$buy_box_display}"{/if}>
                                        <i class="fa fa-shopping-cart">&nbsp;</i>{s name="DetailBuyActionAdd"}{/s}
                                    </button>
                                {/if}
                            {/block}
                        </div>
